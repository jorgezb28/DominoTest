...
{
    public class MockJugadorSinPiezaEnMano
    {
        ...
        public  MockJugadorSinPiezaEnMano()
        {
            _mesaJuego = new List<KeyValuePair<int, Pieza>>(PiezasFactory.GenerarPiezasExtremoA(10));
            _pozoPiezas = new Stack<KeyValuePair<int, Pieza>>(PiezasFactory.GenerarPiezasPozo());
            ...
            {
                new KeyValuePair<int, Pieza>(3, new Pieza(32,44)), 
                new KeyValuePair<int, Pieza>(3, new Pieza(22,44)),
                new KeyValuePair<int, Pieza>(3, new Pieza(12,44)), 
                new KeyValuePair<int, Pieza>(3, new Pieza(32,44)),
                new KeyValuePair<int, Pieza>(3, new Pieza(22,44)), 
                new KeyValuePair<int, Pieza>(3, new Pieza(12,44)),
                new KeyValuePair<int, Pieza>(3, new Pieza(12,44)) 
